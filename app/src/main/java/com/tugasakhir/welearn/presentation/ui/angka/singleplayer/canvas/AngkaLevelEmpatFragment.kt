...
//            Toast.makeText(this, idSoal, Toast.LENGTH_SHORT).show()
            ...
            binding.submitEmpatAngka.setOnClickListener {
                ...
                image.add(Template.encodeImage(binding.cnvsLevelEmpatAngkaOne.getBitmap().scale(100,100))!!)
                image.add(Template.encodeImage(binding.cnvsLevelEmpatAngkaTwo.getBitmap().scale(100,100))!!)
//                Toast.makeText(this, idSoal, Toast.LENGTH_SHORT).show()
                val end = Date().time
