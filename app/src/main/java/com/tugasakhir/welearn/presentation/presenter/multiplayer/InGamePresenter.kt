...
class InGamePresenter(private val useCase: MultiPlayerUseCase): ViewModel() {
    ...
    fun predictHurufMulti(idGame: Int,idSoal: Int,score: Int , duration: Int, authToken: String) = useCase.savePredictHurufMulti(idGame, idSoal,score , duration, authToken)
    fun predictAngkaMulti(idGame: Int,idSoal: Int,score: Int , duration: Int, authToken: String) = useCase.savePredictAngkaMulti(idGame, idSoal,score , duration, authToken)
