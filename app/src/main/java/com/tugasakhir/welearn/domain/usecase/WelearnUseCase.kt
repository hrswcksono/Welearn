...
interface WelearnUseCase {
    ...
    fun angkaPredict(id_soal: Int, image: ArrayList<String>, token: String): Flow<ResultPredict>
    fun hurufPredict(id_soal: Int, image: ArrayList<String>, token: String): Flow<ResultPredict>
