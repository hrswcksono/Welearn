...
interface IMultiplayerDataSource {
    ...
    fun makeRoomGame(id_jenis: Int, id_level: Int, tokenUser: String): Flow<SimpleResponse>
    fun joinGame(idGame: String, tokenUser: String): Flow<SimpleResponse>
    ...
    fun predictAngkaMulti(idGame: Int, idSoal: Int,score: Int , duration: Int, tokenUser: String): Flow<SimpleResponse>
    fun predictHurufMulti(idGame: Int, idSoal: Int,score: Int , duration: Int, tokenUser: String): Flow<SimpleResponse>
