...
interface IMultiplayerDataSource {
    fun getIDSoalMulti(jenis: Int ,level: Int, tokenUser: String): Flow<IDSoalMultiResponse>
    ...
    fun getListScoreMulti(id: Int, tokenUser: String): Flow<List<ScoreMultiResponse>>
